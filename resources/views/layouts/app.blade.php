...
<body>
    ...
    <div id="app">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    CALORIES<label style="color:red;font-size:15px;">| @can('set_calories') Admin @endcan User</label>
                </a>
        ...
        <div aria-live="polite" aria-atomic="true" class="d-flex align-content-end  ">
                
            <div class="toast-container position-absolute bottom-0 start-0 p-3">
          
              <div class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="10000"{{--  data-bs-autohide="false"--}} > 
